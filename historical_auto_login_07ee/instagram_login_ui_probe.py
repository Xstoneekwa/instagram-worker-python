...
def extract_login_screen_signals_from_hierarchy(
    ...
    *,
    ...
    return {
        ...
        # Historical callers consume the email-named flag as the generic
        # "verification code present" gate, so keep it compatible here.
        "email_code_challenge_present": has_verification_code_challenge,
        "verification_code_challenge_present": has_verification_code_challenge,
        "challenge_type": verification_channel,
        "verification_channel": verification_channel,
        "masked_email_present": bool(masked_email_present) if verification_channel == "email" else False,
    ...
    *,
    ...
    if verification_channel:
        ...
        detection_reason = (
            ...
            else "verification_code_required"
        )
        return LoginUiProbeResult(
            ...
            metadata={
                **metadata,
                ...
                "masked_email_present": _has_masked_email_signal(text) if verification_channel == "email" else False,
            },
        )
