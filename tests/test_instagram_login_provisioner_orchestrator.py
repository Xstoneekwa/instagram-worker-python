...
class LoginProvisionerOrchestratorTest(unittest.TestCase):
    ...
    def test_initial_location_services_prompt_is_dismissed_before_connected_fast_exit(self) -> None:
    ...
    def test_initial_location_services_prompt_persistent_fails_closed_without_second_back(self) -> None:
    ...
    def test_login_flow_stale_session_lookup_uses_add_existing_without_fallback(self) -> None:
        ...
        lookup = Mock(
            return_value={
                ...
                "reason": "stale_account_present_without_active_dependency",
                "stale_session_replacement_allowed": True,
                "replacement_safety_status": "allowed",
                "stale_account_state": "unmanaged",
                "connected_account_state": "unmanaged",
                "previous_account_state": "unmanaged",
            }
        )
